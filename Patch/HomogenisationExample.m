...
% simulation easier. AJR, Nov 2017 -- 19 Oct 2023
...
title('space-time solution $u(x,t)$ on patches in space')
%{
\end{matlab}
...
title('spatial structure of $u(x,t)$ in patches at selected times')
%{
\end{matlab}
...
for k = 1:2, subplot(2,2,k)
  ...
  title('stereo of $u(x,t)$ on space-time patches')
end
