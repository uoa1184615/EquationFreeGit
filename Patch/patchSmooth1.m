...
\paragraph{Output}
\begin{itemize}
\item \verb|dudt| is \(\verb|nSubP| \cdot \verb|nVars| \cdot
\verb|nEnsem| \cdot \verb|nPatch|\) vector\slash array of
...
\begin{devMan}
Reshape the fields~\verb|u| as a 4D-array, and sets the
