...
The methodology bypasses the derivation of macroscopic evolution equations by using only short bursts of microscale simulations which are often the best available description of a system \cite[e.g.]{Kevrekidis09a, Kevrekidis04a, Kevrekidis03b}, and often only computing on small patches of the spatial domain \cite[e.g.]{Roberts2011a}.
This suite of functions empowers users to start implementing such methods.
\end{abstract}
