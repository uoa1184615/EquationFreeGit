% Explore the time integration function projInt1() 
% on discretisation of a nonlinear diffusion PDE.  
% Test dependence of errors on macro-time step.
% AJR, Feb 2018
%!TEX root = ../equationFreeDoc.tex
%{
\subsection{\texttt{projInt1Explore2}: explore effect of varying parameters}
\label{sec:pi1eevp}
...
But remember that \verb|projInt1| rounds \verb|timeSteps| etc to nearest multiple of~\verb|dt|, so some of the following is a little dodgy but should not matter for overall trend.
\begin{matlab}
%}
