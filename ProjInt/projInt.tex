% input *.m files for Projective Integration  AJR, Oct 2017 -- May 2026
...
This chapter provides some good projective integration functions \cite[e.g.]{Gear02b, Gear03c, Givon06, Marschler2014b, Maclean2015, Sieber2018}.
...
\paragraph{Time homogenisation}
\cref{sec:ExPIRFode} introduces projective integration to efficiently time-homogenise rapid microscale fluctuations in a system.  
Inspired by \cite{Bunder2013a, vonOertzen2026}.
...
\input{../ProjInt/timeHomogenise.m}
