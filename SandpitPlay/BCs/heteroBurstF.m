...
%!TEX root = doc.tex
%{
\subsection{\texttt{heteroBurstF()}: a burst of heterogeneous diffusion}
...
\verb|patchSys1|.  Try~\verb|ode23|,
although \verb|ode45| may give smoother results.
Sample every period of the microscale time fluctuations (or, at least, close to the period).
\begin{matlab}
%}
