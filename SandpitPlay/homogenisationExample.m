...
if 1, % optionally have random advection and smaller diffusion
  cAdvec = exp(randn(mPeriod,1)); cAdvec=cAdvec/mean(cAdvec)
  patches.b = [repmat(cAdvec,(nSubP-1)/mPeriod,1);cAdvec(1)];
  patches.c = 0.3*patches.c;
end
%{
\end{matlab}
