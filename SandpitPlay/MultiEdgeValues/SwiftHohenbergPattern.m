...
%!TEX root = doc.tex
%{
\section[\texttt{SwiftHohenbergPattern}: simulate
Swift--Hohenberg PDE in 1D \ldots]
{\texttt{SwiftHohenbergPattern}: simulate patterns of the
...
period\(\approx 0.166\), wavenumber \(k_0\approx 38\). On
medium times these spatial oscillations grow to near
equilibrium amplitude of~\(\sqrt{\Ra}\), and over very long
times the phases of the oscillations evolve in space to
